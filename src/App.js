...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* <Pagination showPerPage={showPerPage} onPaginationChange={onPaginationChange} total={total}></Pagination> */}
      <PaginationBar showPerPage={showPerPage} onPaginationChange={onPaginationChange} total={total}></PaginationBar>
    </div>
  );
}
